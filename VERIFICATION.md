...
701–1050px 直向改用 full-mobile 新全屏影片及 poster，取消舊 normal-mobile 選片。標題上方、簡介下方、古銅金字色及細微提亮，隱藏大 CTA。觸控平板橫向沿用寬屏捲動影片，另設置頂標題及底部簡介、隱藏大 CTA；電腦滑鼠模式不變。

820×1180 視覺確認；768×1024、1024×1366 確認新影片、大 CTA 隱藏及無 mask。390×844、1180×820、1440×900 無橫向 overflow。1180×820 刷新確認 scroll-desktop.mp4 初始暫停。Console 無錯誤，動畫／開頁位置模擬測試通過。觸控 pointer:coarse 分支與真機 iPad Safari 尚未實測，不能視作完整真機相容認證。

## 電腦首頁字體同步

電腦首頁及導覽沿用手機古銅金與輕微字邊提亮，標題採 Georgia 襯線；保留電腦字級、排位、CTA 配色及影片動畫。1440×900 已視覺確認，標題 rgb(120,82,29)，無橫向 overflow。
